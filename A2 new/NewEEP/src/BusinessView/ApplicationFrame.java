 ...
 * The main application which composes from other frames
 *
 *****************************************************************************/
public class ApplicationFrame extends javax.swing.JFrame {
    ...
    InventoryMainFrame inventory = new InventoryMainFrame(login);
    ShippingNewJFrame shipping = new ShippingNewJFrame(login);
    OrderNewJFrame order = new OrderNewJFrame(login);
