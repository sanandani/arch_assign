...
public class ExtrapolatedPressureSink extends InstrumentationFilter
{
		public void run()
    {
		int bytesread = 0, numberOfBytes = 0, indexOfWildPoint = 0;				// This is the number of bytes read from the stream
	...
	private void writeNormalRecord(ArrayList<InstrumentationData> currentRecord, BufferedWriter out) throws IOException {
	...
	private void writeWildRecord(ArrayList<InstrumentationData> currentRecord, int indexOfWildPoint, BufferedWriter out) throws IOException {
		for(int i = 0; i< currentRecord.size(); i++){
