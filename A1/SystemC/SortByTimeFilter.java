...
public class SortByTimeFilter extends InstrumentationFilter {
    ...
    public void run() {
		...
		*************************************************************
        ...
        /**
         * ***********************************************************
         * Creating an Arraylist of arraylist which will help to store data and
         * write it to the next filter
		/************************************************************
         */
        ...
        while (true) {
            try {
                 ...
                 * to be an ID and // so we read Id first and increment bytes
                 * read by IdLength.
				***************************************************************************
                 */
                id = readId();
...
/**
 * *************************************************************************
 * // Storing the the data id and measurement in instrumentdata object // This
 * object will be stored in a ArrayList which will later used for sorting
***************************************************************************
 */
...
/**
 * *************************************************************************
 * //Storing the the data id and measurement in instrumentdata object and //then
 * storing the data in ArrayList instrumentationDataList which will // help in
 * sorting the data 
***************************************************************************
 */
