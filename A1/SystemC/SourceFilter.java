...
public class SourceFilter extends SinglePortFilterFramework
{
	...
	public void run()
    {
		...
		***********************************************************************************/
		...
		{
			System.out.println("\n" + this.getName() + "::Source Filter End of file reached..." );
			try
			{
				in.close();
				ClosePorts();
				System.out.println( "\n" + this.getName() + "::Source Filter Read file complete, bytes read::" + bytesread + " bytes written: " + byteswritten );
